...
namespace DialogueEditor
{
    ...
    public class ConversationManagerEditor : Editor
    {
        ...
        SerializedProperty NextButtonProperty;
        SerializedProperty EndButtonProperty;
        ...
        private void OnEnable()
        {
            ...
            EndButtonProperty = serializedObject.FindProperty("EndButton");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Next button image
            GUILayout.Label("Next Button Image", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(NextButtonProperty);
            EditorGUILayout.Space();

            // End Button image
            GUILayout.Label("End Button Image", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(EndButtonProperty);
            EditorGUILayout.Space();
        ...
        private void RenderPreviewImage(ConversationManager t)
        {
            ...
            // Next End button
            Rect nextEndRect = new Rect(boxRect.xMax - 80, boxRect.yMax - 30, 60, 20);
            EditorGUI.DrawRect(nextEndRect, Color.white);
            Rect tmplt = new Rect(nextEndRect);
            tmplt.x += 4f;
            EditorGUI.LabelField(tmplt, "<Next-End>");
